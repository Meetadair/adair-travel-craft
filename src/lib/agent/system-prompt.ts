...
export function systemPrompt(context: PromptContext): string {
  const lines: string[] = [
    ...
    "- Restaurants: you can suggest and you can find, but you cannot hold a table yet — no one at",
    "  Adair calls ahead on a traveller's behalf, ever. Say so plainly and offer what you can — the",
    "  name and roughly where it is. Never say you have booked one, never say you will, and never",
    "  imply a person will follow up.",
