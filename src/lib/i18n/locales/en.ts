...
export const en = {
  ...
  assistant: {
    ...
    strip: {
      ...
      controls: {
        ...
        roundTrip: "Return",
        flexible: "\u00b1 3 days",
        pickReturn: "Pick the day you come back too.",
        nightsLabel: "or nights:",
        nightsWord: "nights",
        searchDates: "Search these dates",
        changeDates: "Change dates",
        flexSaveLead: "Save",
        flexSaveTail: "by leaving",
        flexSaveApply: "Use these dates",
        cabinLabel: "Cabin",
        economy: "Economy",
        premiumEconomy: "Premium economy",
        business: "Business",
        first: "First",
        whoLabel: "Who is travelling",
        ageNote: "Ages on the day of departure.",
        adults: "Adults",
        adultsAge: "16 and over",
        teenagers: "Teenagers",
        teenagersAge: "12–15",
        children: "Children",
        childrenAge: "2–11",
        infantsSeat: "Infants with a seat",
        infantsSeatAge: "under 2",
        infantsLap: "Infants on a lap",
        infantsLapAge: "under 2",
        seatsLeft: "seats left",
        needAdult: "Someone over 16 has to be on the booking.",
        needLap: "Every infant on a lap needs an adult.",
        airportSearch: "Search airports",
        airportEmpty: "No airport by that name.",
        airportOther: "Or search another airport",
        timeLabel: "Or a time",
        travellersLabel: "How many people",
        companionsHint: "People you travel with",
        done: "Done",
      },
    },
  ...
  auth: {
    ...
    accountExists:
      "You already have an account with this address. Sign in, or reset your password.",
    forgotPassword: "Forgot your password?",
    resetTitle: "Reset your password",
    resetLead: "Tell us your email address and we'll send you a link to set a new password.",
    resetSend: "Send the link",
    resetSent: "If that address has an account, the link is on its way. Check your inbox.",
    resetNoEmail:
      "We can't send email yet, so the reset link could not go out. Please contact us instead.",
    backToSignIn: "Back to sign in",
    newPasswordTitle: "Set a new password",
    newPassword: "New password",
    newPasswordSave: "Save the new password",
    newPasswordSaved: "Saved. You're signed in.",
    newPasswordExpired: "This link has expired. Ask for a new one.",
