...
- [ ] Task 0: move "For companies" out of the top nav to the footer (it is an offer page, not the user panel)
- [ ] Task 1: verify typecheck + preview, Invoices/Settings in nav, invoice email after booking
- [ ] Task 2: peak-pricing baseline comparison (±3/7/14 days), Claude event naming, ask-to-move-dates prompt (leisure only)
